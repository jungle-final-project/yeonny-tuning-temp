...
| `POST` | `/api/agent/as-requests` | AGENT | 4번 | `Idempotency-Key: {diagnosisId}` + `{ "diagnosisId": "...", "resultId": "...", "deviceId": "...", "requestType": "PHYSICAL_INSPECTION", "symptom": "게임 실행 후 프레임 저하", "diagnosisTitle": "GPU 냉각 계통 이상 가능성", "diagnosisSummary": "...", "evidenceSummary": [{ "component": "gpu", "metricType": "temperature", "value": 95, "unit": "°C" }], "diagnosedAt": "...", "mode": "LIVE", "consentAccepted": true }` | `201 { "requestId": "...", "requestNumber": "AS-20260714-000001", "status": "OPEN", "requestType": "PHYSICAL_INSPECTION", "symptom": "...", "diagnosisTitle": "...", "diagnosisSummary": "...", "evidenceSummary": [...], "diagnosedAt": "...", "mode": "LIVE", "createdAt": "...", "supportChatRoomId": "...", "webPath": "/support/{requestId}" }`. 실시간 진단 접수는 원본 JSONL 업로드가 아니며 검증된 `evidenceSummary`를 `as_tickets.evidence_summary`에 저장한다. | `as_tickets`, `support_chat_rooms` |
