...
2026-07-02 RAG vector 정책 결정 요약은 `docs/reports/rag-vector-policy-decision-20260702.md`를 기준으로 본다. 결론은 전역 vector 유지, 경로별 override 기본값 유지, `REQUIREMENT_PARSE`와 `BUILD_RECOMMEND`는 seed/rerank 품질 개선 대상으로 분리다.
