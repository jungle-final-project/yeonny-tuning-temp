...
| `model_version` | `VARCHAR(120)` | no | - | 모델 버전 stable key |
...
| `excluded_reason` | `TEXT` | yes | - | 제외 사유 |
...
| `status` | `VARCHAR(30)` | no | - | `QUEUED`, `RUNNING`, `SUCCEEDED`, `FAILED`, `CANCELLED`, `SKIPPED_LOW_DATASET` |
