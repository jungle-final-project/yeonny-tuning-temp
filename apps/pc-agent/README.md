...
4번 담당자의 PC Agent/AS 흐름 시작점입니다. 현재는 실제 Windows Service나 installer가 아니라, AS 업로드 테스트에 사용할 JSON Lines 로그를 만들고 사용자가 확인한 IncidentWindow 구간을 gzip 업로드하는 CLI/트레이 MVP입니다.
