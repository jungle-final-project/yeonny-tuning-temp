...
export const SLOT_BOARD_BG = '/slot-board/backgrounds/pc_map.png';

// 목표 이미지처럼 메인보드의 실제 장착 위치가 먼저 읽히도록 잡은 기본 좌표(%).
// 관리자 저장 좌표가 있으면 이 좌표는 fallback으로만 사용된다.
export const SLOT_CONFIGS: SlotConfig[] = [
  { category: 'CPU', label: 'CPU', glyph: '/slot-board/parts/cpu.svg', fixedIcon: '/slot-board/icons/cpu.png', layout: { x: 14, y: 33, w: 19.94, h: 13.85 } },
  { category: 'RAM', label: 'RAM', glyph: '/slot-board/parts/ram.svg', fixedIcon: '/slot-board/icons/ram.png', miniSlots: 4, miniFillBy: 'quantity', layout: { x: 44, y: 4, w: 17.10, h: 14.08 } },
  { category: 'STORAGE', label: 'SSD', glyph: '/slot-board/parts/ssd.svg', fixedIcon: '/slot-board/icons/ssd.png', miniSlots: 2, miniFillBy: 'items', layout: { x: 72, y: 15, w: 16.50, h: 12.19 } },
  { category: 'COOLER', label: '쿨러', glyph: '/slot-board/parts/cooler.svg', fixedIcon: '/slot-board/icons/fan.png', layout: { x: 14, y: 14.85, w: 19.41, h: 13.02 } },
  { category: 'MOTHERBOARD', label: '메인보드', glyph: '/slot-board/parts/motherboard.svg', fixedIcon: '/slot-board/icons/motherboard.png', layout: { x: 35.76, y: 74, w: 23, h: 12 } },
  { category: 'GPU', label: 'GPU', glyph: '/slot-board/parts/gpu.svg', fixedIcon: '/slot-board/icons/gpu.png', layout: { x: 8, y: 54, w: 22.73, h: 13.96 } },
  { category: 'PSU', label: '파워', glyph: '/slot-board/parts/psu.svg', fixedIcon: '/slot-board/icons/psu.png', layout: { x: 67, y: 62, w: 21.15, h: 13.37 } },
  { category: 'CASE', label: '케이스', glyph: '/slot-board/parts/case.svg', layout: { x: 72, y: 48, w: 23, h: 12 } }
];
