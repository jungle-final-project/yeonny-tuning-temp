...
class PartReplacementRankerTest {
    ...
    void categoryMatrixKeepsUpgradeDowngradeAndSimilarPriceDirection() {
        for (String category : List.of("GPU", "CPU", "RAM", "STORAGE", "PSU", "MOTHERBOARD", "CASE", "COOLER")) {
            List<AiChatResponseDto.PartRecommendation> candidates = tieredParts(category);
            ...
            assertThat(upgrade.parts())
                    ...
                    .extracting(AiChatResponseDto.PartRecommendation::partId)
    ...
    private static List<AiChatResponseDto.PartRecommendation> tieredParts(String category) {
        return List.of(
    ...
    private static AiChatResponseDto.PartRecommendation part(String category, String tier, int price) {
    ...
    private static AiChatResponseDto.PartRecommendation gpu(
            String id,
            String name,
            int price,
            String gpuClass,
