...
public class PartReplacementRanker {
    ...
    public SelectionResult select(
        ...
        AiChatResponseDto.PartRecommendation currentPart = candidates.stream()
    ...
    public Double rank(AiChatResponseDto.PartRecommendation part) {
        if (part == null) {
            return null;
        }
    ...
    private Double tierRank(AiChatResponseDto.PartRecommendation part) {
        if (part == null) {
            return null;
        }
