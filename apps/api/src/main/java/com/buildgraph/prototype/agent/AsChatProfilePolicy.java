...
public class AsChatProfilePolicy {
    ...
    private static AiProfile escalationTarget(AiProfile profile) {
        return switch (profile) {
            case AS_CHAT_FAST, AS_CHAT_54_FAST, AS_CHAT_54_MINI_FAST, AS_CHAT_NANO_FAST -> AiProfile.AS_CHAT_BALANCED;
            case AS_CHAT_BALANCED, AS_CHAT_HIGH_QUALITY -> profile;
            case BUILD_CHAT_FAST, BUILD_CHAT_54_FAST, BUILD_CHAT_54_MINI_FAST -> profile;
        };
    }
