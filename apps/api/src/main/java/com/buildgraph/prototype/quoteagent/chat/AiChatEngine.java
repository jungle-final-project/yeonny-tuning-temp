...
public class AiChatEngine {
    ...
    public AiChatResponseDto LLMorchestrator(AiChatRequestDto request, String selectedAi) {
        ...
        /* 1. sessionId 관리
           2. llm 응답 준비 */
        AiChatSessionState session = aiChatSessionStore.findOrCreate(request.sessionId(), request.userInternalId());
        ...
        aiChatSessionStore.updateSession(sessionId, request.userInternalId(), newContextPatch);
    ...
    private AiChatResponseDto conversationResponse(
        ...
        aiChatSessionStore.updateSession(sessionId, userInternalId, newContextPatch);
